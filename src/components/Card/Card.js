...
export default function Card(props) {
  ...
  return (
    <>
        <div className="card-container" style={darkMode ? { backgroundColor: '#3a3737d2'} :{}}>
            <div className="card-id-wrapper">
                <div className="card-id">{props.cardDetails?.id}</div>
                <div className="card-profile" style={{background:"gray"}}>
            ...
            <div className="card-title" style={darkMode ?{ backgroundColor: '', color:'white' } :{}}>
